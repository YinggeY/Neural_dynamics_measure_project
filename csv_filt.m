...
% For anat_wake, filtered subjects are sub09, sub15, and sub18
...
for i = 1:3
    ...
    data = strcat('EEG_Passive_anat_wake_epoch_0_4_clean_filt_4-13_',subj,'.mat');
    load(data,'LZ_HGSN');
   ...
   % and anat_wake
   save_aaw = strcat(awdir,'/',subj,'_aw_filt_4-13_alert.csv');
   save_daw = strcat(awdir,'/',subj,'_aw_filt_4-13_drowsy.csv');
